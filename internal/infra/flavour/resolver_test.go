...
func TestConventionResolver_Resolve(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			agentImage: "ghcr.io/stacklok/brood-box/claude-code:latest",
			flavour:    domflavour.Go,
			want:       "ghcr.io/stacklok/brood-box/claude-code-go:latest",
		},
		{
			name:       "python flavour with tag",
			agentImage: "ghcr.io/stacklok/brood-box/codex:latest",
			flavour:    domflavour.Python,
			want:       "ghcr.io/stacklok/brood-box/codex-python:latest",
		},
		{
			name:       "node flavour with tag",
			agentImage: "ghcr.io/stacklok/brood-box/opencode:v1.0",
			flavour:    domflavour.Node,
			want:       "ghcr.io/stacklok/brood-box/opencode-node:v1.0",
		},
		{
			name:       "rust flavour without tag",
			agentImage: "ghcr.io/stacklok/brood-box/claude-code",
			flavour:    domflavour.Rust,
			want:       "ghcr.io/stacklok/brood-box/claude-code-rust",
		},
		{
			name:       "generic returns unchanged",
			agentImage: "ghcr.io/stacklok/brood-box/claude-code:latest",
			flavour:    domflavour.Generic,
			want:       "ghcr.io/stacklok/brood-box/claude-code:latest",
		},
		{
		...
		},
		{
			...
			agentImage: "localhost:5000/brood-box/claude-code:latest",
			flavour:    domflavour.Go,
			want:       "localhost:5000/brood-box/claude-code-go:latest",
		},
		{
